...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func scheduleNotification(at date: Date, id: Int, item: BudgetItem) {
        ...
        content.title = "You have a bill to pay!"
        content.body = "The bill is for " + item.name
    ...
    func removePendingNotification(id: Int) {
